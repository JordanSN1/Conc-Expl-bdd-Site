...
Chez PhantomBurger, nous avons un secret bien gardé : le croustillant irrésistible de notre poulet. Oui, celui qui fait saliver vos papilles et vous pousse à savourer chaque morceau de nos fameux Buckets®, jusqu’à la dernière miette ! Mais ce goût unique ne se limite pas qu’à la recette de notre poulet.

Derrière chaque bouchée croustillante se cache une véritable démarche d'engagement. Nous nous engageons non seulement pour vous offrir des produits de qualité, mais aussi pour soutenir nos équipes et préserver notre environnement. Chez nous, chaque ingrédient est sélectionné avec soin, chaque employé est valorisé, et chaque action est pensée pour réduire notre empreinte écologique.

Jour après jour, comme nous suivons nos recettes avec précision, nous appliquons nos engagements avec la même rigueur. Car chez PhantomBurger, chaque choix compte pour faire de votre expérience gustative un moment unique. Découvrez dès maintenant notre engagement envers la qualité, l’humain et la planète.
                </p>
            </div>
        </div>
    </section>
...
<div class="projects-container">
    ...
    <section class="team">
        ...
        <div class="card">
                <div class="card-img">
                    <img src=
"../img/afficherPhotoUtilisateur.jpg" alt="User 1">
                </div>
                <div class="card-info">
            ...
            <div class="card">
                <div class="card-img">
                    <img src=
"../img/Capture d’écran 2024-10-01 095249.png" alt="User 1">
                </div>
                <div class="card-info">
