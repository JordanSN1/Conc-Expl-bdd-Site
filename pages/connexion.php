...
if (isset($_SESSION['utilisateur_id']) && basename($_SERVER['PHP_SELF']) !== 'connexion.php') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if (password_verify($password, $hashed_password)) {
                ...
                header("Location: index.php");  // Ou vers la page de votre choix
                exit();
            } else {
...
<header>
    <nav>
        ...
        <div class="user-actions">
            <?php
            if (isset($_SESSION['utilisateur_id'])) {
                echo '<a class="panier" href="inscription.php">Inscription</a>';
            } else {
        ...
        <div class="form-box">
            <form action="connexion.php" method="POST">
                ...
                <div class="account-creation">
                    <span>Vous n'avez pas de compte ? <a href="inscription.php" class="inscr-btn">S'inscrire</a></span>
                </div>
            </form>
        </div>
    </div>
